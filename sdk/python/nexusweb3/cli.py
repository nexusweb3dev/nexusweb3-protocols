...
def build_parser() -> argparse.ArgumentParser:
    ...
    ren = identity.add_parser("rename", help="take a new unique name and release the old one")
    ren.add_argument("--name", required=True, help="the new name; lowercase a-z, digits, - _ . only")
    _add_agent_arg(ren)
    ren.set_defaults(handler=handlers.identity_rename)
